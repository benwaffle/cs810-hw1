...
expr:
    ...
    | LETREC; x = ID; LPAREN; y = ID; COLON; targ=texpr; RPAREN; COLON
      ; tr=texpr; EQUALS; e1 = expr; IN; e2 = expr { Letrec(tr,x,y,targ,e1,e2) }
    | LETREC; x = ID; LPAREN; y = ID; RPAREN; EQUALS; e1 = expr; IN; e2 = expr { LetrecUntyped(x,y,e1,e2) }
    | PROC; LPAREN; x = ID; COLON; t=texpr; RPAREN; LBRACE; e = expr; RBRACE { Proc(x,t,e) }
    | PROC; LPAREN; x = ID;  RPAREN; LBRACE; e = expr; RBRACE { ProcUntyped(x,e) }
...
texpr:
    ...
    | REFTYPE; LPAREN; t1 = texpr; RPAREN { RefType(t1) }
